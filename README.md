...
API Laravel do FichAqui. Integração Mercado Pago (PIX, cartão): variáveis em `.env.example` e guia em [`docs/integrations/mercadopago-qr-orders.md`](docs/integrations/mercadopago-qr-orders.md).

**Sandbox:** com `MP_SANDBOX=true`, use um usuário com e-mail `@testuser.com` (ex.: `maria@testuser.com` do seed) para testar checkout cartão/PIX.
